...
var combo5 = createPromotion("Lembranca-de-inverno","Lembrança de inverno","Fondue com vinho branco.") + createPromotion("Romeu-e-Julieta","Pastel Romeu e Julieta","A clássica junção de queixo e goiabada em um pastel sequinho.") + createPromotion("Espetinho-de-carne","Churrasquinho de semana","Espetinho de carne assada pra te lembrar do final de semana.") + createPromotion("Frescor-de-verão","Frescor de verão","Torta de sorvete de flocos");
